...
class wliPopularPosts {
	...
	public function wli_enqueue_popular_posts_admin_styles_scripts( $hook ) {
		...
		wp_enqueue_style( 'ppbw-css', PP_URL . '/admin/assets/css/ppbw-admin-notices.css', array(), WLIPOPULARPOSTS_VERSION );
	}
		...
		<div class="main-div">	
			...
			<div class="div2">	
				...
				if (!(isset($all_plugins['xml-sitemap-for-google/xml-sitemap-for-google.php']))) {
					?>
						<div class="ppbw-plugin-cta show-other-plugin" id="xml-plugin-banner">
							...
							<button id="open-install-ppbw" class="button-install">Install Plugin</button>
						</div>
					<?php 
				}
				?>	
